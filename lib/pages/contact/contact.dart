...
class Contact {
  static final tblContact = "Contact";
  ...
  Contact({this.id, this.corporationId, this.corporationName, this.thumbnail, this.image, this.createdateIntro ,
  ...
  Contact.update({this.id, this.corporationId, corporationName = "", thumbnail = "", image="",  createdateIntro="",
